...
class ConvBody(nn.Module):
    ...
    def __init__(
        ...
        # 84*84*3
        self.conv1 = nn.Conv2d(in_channels, out_channels=4, kernel_size=5, stride=2)
        #self.mp1 = nn.MaxPool2d(kernel_size=2, stride=2)
        
        # 40*40*4
        self.conv2 = nn.Conv2d(4, 6, kernel_size=5, stride=2)
        #self.mp2 = nn.MaxPool2d(kernel_size=2, stride=2)

        # 18*18*6
        self.conv3 = nn.Conv2d(6, 8, kernel_size=3, stride=2)
...
class ConvPoolBody(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            input_size: size of the image (given that width = height). Defaults to 84.
        """
        super(ConvPoolBody, self).__init__()
        # 84*84*3
